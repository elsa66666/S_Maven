...
def download_dataset(dataset_name):
    ...
    if dataset_name == 'cikm18':
        company_list = ['AAL', 'AAPL', 'ABBV', 'ABT', 'AGN', 'AMGN', 'AMZN', 'AXP', 'BA', 'BAC', 'BLK', 'BMY', 'C', 'CAT', 'CELG', 'CHK', 'CMCSA', 'CMG', 'CSCO', 'CVS', 'CVX', 'DIS', 'F', 'FB', 'FCX', 'GE', 'GILD', 'GS', 'HD', 'IBM', 'INTC', 'JNJ', 'JPM', 'KO', 'MCD', 'MMM', 'MRK', 'MSFT', 'NKE', 'PFE', 'PG', 'TRV', 'UNH', 'UTX', 'UZ', 'WMT', 'XOM']
        ...
        company_list = ['APPL', 'AEP', 'AGFS', 'AMGN', 'AMZN', 'BA', 'BAC', 'C', 'CAT', 'CACSA', 'CODI', 'CSCO', 'CVX', 'D', 'DIS', 'DUK', 'EXC', 'GD', 'GE', 'GMRE', 'GOOG', 'HD', 'HON', 'INTC', 'JNJ', 'JPM', 'KO', 'LMT', 'MA', 'MCD', 'MDT', 'MMM', 'MO', 'MRK', 'MSFT', 'NEE', 'ORCL', 'PCG', 'PM', 'PPL', 'REX', 'SO', 'SRE', 'T', 'UPS', 'V', 'VZ', 'WFC', 'WMT', 'XOM']
...
if __name__ == "__main__":
    download_dataset('acl18')
    download_dataset('cikm18')
    download_dataset('bigdata22')
